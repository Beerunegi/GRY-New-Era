          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8 pt-6 border-t border-border/50 max-w-sm">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm font-bold opacity-80 uppercase tracking-widest text-[10px]">100% Attribution</div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-secondary/5 border border-secondary/10">
                  <Activity className="w-5 h-5 text-secondary" />
                </div>
                <div className="text-sm font-bold opacity-80 uppercase tracking-widest text-[10px]">Real-Time Data</div>
              </div>
            </div>
          </motion.div>
