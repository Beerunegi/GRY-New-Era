        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-6 leading-[1.1]">
              Convert More <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary/80 to-secondary selection:bg-primary/20">Visitors Into Customers</span>
            </h1>
            
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-lg">
              Stop wasting traffic. Our data-driven CRO strategies optimize every touchpoint to increase your sales, leads, and revenue without increasing your ad spend.
            </p>
          ...
          >
            <div className="relative aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl border border-border/50 group bg-muted">
              <Image 
                ...
                alt="Conversion Rate Optimization Analytics" 
                fill 
            ...
            <div className="absolute -bottom-6 -right-6 bg-card/80 backdrop-blur-xl p-5 rounded-3xl border border-white/20 shadow-2xl hidden md:block">
              <div className="text-2xl font-black text-primary mb-1 tracking-tight">+45% CONVERSION</div>
              <div className="text-[9px] text-muted-foreground font-black uppercase tracking-[0.2em]">Average Client Growth</div>
            </div>
          </motion.div>
        </div>
      </div>
